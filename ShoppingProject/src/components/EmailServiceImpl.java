...
public class EmailServiceImpl implements EmailService,Cloneable{
	...
	private EmailServiceImpl(Properties prop) {
		this.prop=prop;
	}
	
	public static EmailServiceImpl getEmailServiceImpl(Properties prop) {
		if(emailServiceImpl==null) {
			emailServiceImpl=new EmailServiceImpl(prop);
		}
		return emailServiceImpl;
	}
	
	public EmailServiceImpl createClone() {
		try {
