package InternExercise.day5; //the package should be first line in any program. Comments can be made before that.
...
public class Day5 {
	...
	void question1() {
		float f = 1.3; // we should include f along the value because by default the value is double
						// type.
